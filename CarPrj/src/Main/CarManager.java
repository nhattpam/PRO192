...
public class CarManager {
    public static void main(String[] args) throws NumberFormatException, IOException {
        ...
        brandList.loadFromFile("F:\\workshops\\CarPrj\\src\\brands.txt");
        CarList carList = new CarList(brandList);
        carList.loadFromFile("F:\\workshops\\CarPrj\\src\\cars.txt");
        ...
        do {
            ...
            switch(choice) {
                ...
                case 5: brandList.saveToFile("F:\\workshops\\CarPrj\\src\\brands.txt"); break;
                ...
                case 11: carList.saveToFile("F:\\workshops\\CarPrj\\src\\cars.txt"); break;
